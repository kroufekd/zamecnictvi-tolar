<?php 
    ...
    <div class="container"><a class="navbar-brand logo" href="index.php">Zámečnictví Martin Tolar</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div
